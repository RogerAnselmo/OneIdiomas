...
namespace One.Application.Extractors
{
    public static class EditarResponsavelExtractor
    {
        public static EditarResponsavelViewModel ConvertToEditarResponsavelViewModel(ACResponsavel ACResponsavel)
        {
            ...
            return new EditarResponsavelViewModel
            {
        ...
        {
            CodigoUsuario = editarResponsavelViewModel.CodigoUsuario,
            DataNascimento = Convert.ToDateTime(editarResponsavelViewModel.DataNascimento),
            CodigoResponsavel = editarResponsavelViewModel.CodigoResponsavel,
            CPF = editarResponsavelViewModel.CPF,
            RG = editarResponsavelViewModel.RG,
            flAtivo = "A"
        };
