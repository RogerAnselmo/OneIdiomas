...
{
    public class CadastroResponsavelPage : LoggenInBasePage
    {
        public override string Url => "http://localhost:4927/Gerenciar-Responsavel/Cadastro-Responsavel/";
        ...
        public void NovoResponsavelClick() => driver.FindElement(By.Id("btNovoResponsavel")).Click();
    }
}
